...
HTML is what gives your webpage meaning and provides imformation in the webpage.
...
This property would work on the cross axis.

4. Explain why git is valuable to a team of developers.

Git allows a  team of developers to work seperately without having an impact on the work of others.

5. Define mobile-first design in your own words.

Today mobile internet usage has surpassed desktop so making sure mobile view designs are taken care of first creates a better expierence for users.
